...
export function codeFromMarkdown() {
    ...
    function exitCodeMeta(token) {
        ...
        this.buffer() // important, but why? */
        console.log(`'1-2':`, JSON.stringify(this.stack))
    }
    ...
    function existCodeData(token) {
        console.log(`'2-1':`, JSON.stringify(this.stack))
        const data = this.resume()
        let node = this.stack[this.stack.length - 1]
        /**@ts-ignore */
        node.value = data
        this.buffer() /** // important, but why? */
        console.log(`'2-2':`, JSON.stringify(this.stack))
    }
    ...
    function exitCodeBlcok(token) {
        console.log(`'3-1':`, JSON.stringify(this.stack))
        const data = this.resume()
        const node = this.stack[this.stack.length - 1]
        this.exit(token)
        ...
        /**@ts-ignore */
        node.props = data
        console.log(`'3-2':`, JSON.stringify(this.stack))
    }
